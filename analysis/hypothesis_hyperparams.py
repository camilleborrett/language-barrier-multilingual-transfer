...
def hypothesis_hyperparams(dataset_name=None, df_cl=None, embeddings=False):
    ...
    if dataset_name == "cap-us-court":
        ...
        explicit_labels_dic_long = OrderedDict({
            ...
            'Law and Crime': "law and crime, for example: law enforcement agencies, or white collar crime, or illegal drugs, or court administration, or prisons, or juvenile crime, or child abuse, or family issues, or criminal and civil multilingual-repo, or police",

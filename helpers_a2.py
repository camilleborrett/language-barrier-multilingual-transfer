...
def calculate_distribution(df_func=None, df_label_col="label_text_pred", exclude_no_topic=None, normalize=None, meta_data=None, algorithm=None, representation=None, size=None, languages=None):
    ...
    # harmonise df format to handle random bug which produces different output for df_viz_count only in some random scenarios

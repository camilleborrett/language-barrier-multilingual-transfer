...
python ./data-preparation/translation-manifesto-8.py --dataset $dataset --nmt_model $nmt_model --batch_size $batch_size  &> ./data-preparation/logs-translate-$dataset-$nmt_model-$study_date.txt
